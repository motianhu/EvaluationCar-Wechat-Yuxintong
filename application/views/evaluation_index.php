...
<body style="background-color:#0069b7">
	...
	<div class="MainBody pg">
		<div class="mainInfoBody">
                            <div style="float:center;color:white">
                            <img src="/static/img/Evaluation_logo.png" style="width:20px;height:20px;padding:0px;margin:0px;vertical-align:middle;"/>
                            欢迎<b>
			...
			<div style="float:right;color:white">您好:<?php echo $chineseName.'('.$englishName.')';?></div>		
	<!------------------登记证--------------------->
			<header class="header">
		      <section>
			...
			<div style="clear:both;">
				<div style="padding:10px 0;color:white"><span style="color:red;">*</span>预售价格：<input type="number" name="preSalePrice" min="0" id="ysjg" class="ysjg" /></div>
			</div>
			<?php if($is_show_aid == 'true'){?>
			<div style="clear:both;">
				<div style="padding:10px 0;color:white"><span style="color:red;">*</span>申请单号：<input type="text" name="applyCarBillId" id="applyCarBillId" class="ysjg" /></div>
			</div>
			<?php }?>
